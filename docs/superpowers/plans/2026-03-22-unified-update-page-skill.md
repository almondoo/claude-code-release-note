...
- データファイル（releases-_.json, version-details-_.json の構造とファイル分割ルール）
- 情報ソース（CHANGELOG + Docs の2段階。ユーザー直接提供パスの記載）
- データスキーマ（releases-_.json と version-details-_.json の JSON フォーマット）
    ...
    "steps": [
      {
        ...
        "tags": ["string"],
        "code": [
          { "lang": "string", "label": "string", "value": "string", "recommended?": "boolean" }
        ],
        ...
        "items": [
          {
            ...
            "tags": ["string"],
            "examples?": [
              { "strategy": "string", "before": "string", "after": "string", "detail?": "string" }
            ],
            "tips?": ["string"],
        ...
        "items": [
          {
            ...
            "tags": ["string"],
            "examples?": [
              { "strategy": "string", "detail?": "string", "before": "string", "after": "string" }
            ],
            "tips?": ["string"],
...
- commands: SECTION*COLORS/SECTION_ICONS（旧 CATEGORY*\* を修正）、分類ルール、9カテゴリ
