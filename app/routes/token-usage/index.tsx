  ...
  return (
    <div className="min-h-screen bg-slate-900 font-sans text-slate-100">
      <div className="max-w-[1400px] mx-auto px-4 py-8">
        ...
        <PageHeader
          title="トークン使用量計測ガイド"
          description="Claude Code のトークン消費量を計測・可視化するための方法を、ビルトインツールからチーム向けソリューションまで網羅。"
          stats={[
            { value: SECTIONS.length, label: "カテゴリ" },
            { value: TOTAL_ITEMS, label: "手法" },
          ]}
        ...
        <motion.div
          ...
          className="mb-4"
        >
          <SearchInput value={query} onChange={setQuery} placeholder="手法を検索..." />
        </motion.div>

        {/* Count */}
        <div className="flex items-center gap-2.5 mb-4 px-1">
          <span className="text-[14px] text-slate-500 font-medium">
            {visibleItemCount} / {TOTAL_ITEMS} 手法
          </span>
        </div>
