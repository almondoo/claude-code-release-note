...
export const SECTION_ICONS: Record<string, () => React.JSX.Element> = {
  "guide-overview": () =>
    iconSvg("M2 3h6a4 4 0 014 4v14a3 3 0 00-3-3H2V3zM22 3h-6a4 4 0 00-4 4v14a3 3 0 013-3h7V3z"),
  ...
  "infra-components": () =>
    iconSvg("M6 18h8M3 22h18M12 2v4M12 6a4 4 0 014 4c0 2-2 3-2 6H10c0-3-2-4-2-6a4 4 0 014-4z"),
  "security-overview": () => iconSvg("M12 2l8 4v6c0 5.25-3.5 10-8 11-4.5-1-8-5.75-8-11V6l8-4z"),
  "security-data-protection": () =>
    iconSvg("M12 2l8 4v6c0 5.25-3.5 10-8 11-4.5-1-8-5.75-8-11V6l8-4zM12 12v4M12 8h.01"),
  "security-access-control": () =>
    iconSvg(
      "M21 2l-2 2m-7.61 7.61a5.5 5.5 0 11-7.78 7.78 5.5 5.5 0 017.78-7.78zM15.5 7.5l3 3L22 7l-3-3-3.5 3.5z",
    ),
  "security-network": () =>
    iconSvg(
